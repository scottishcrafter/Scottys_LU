...
public class CustomPoleModelChange extends HorizontalFacingBlock {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext ctx) {
        ...
        return switch (dir) {
            case NORTH -> VoxelShapes.cuboid(0.5, 0, 0.5, 0.6, 1, 0.6);
            case SOUTH -> VoxelShapes.cuboid(0.5, 0, 0.5, 0.6, 1, 0.6);
            case EAST -> VoxelShapes.cuboid(0.5, 0, 0.5, 0.6, 1, 0.6);
            case WEST -> VoxelShapes.cuboid(0.5, 0, 0.5, 0.6, 1, 0.6);
