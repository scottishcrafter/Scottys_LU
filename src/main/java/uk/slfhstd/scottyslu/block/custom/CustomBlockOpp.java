...
public class CustomBlockOpp extends HorizontalFacingBlock {
    public static final MapCodec<CustomBlockOpp> CODEC = Block.createCodec(CustomBlockOpp::new);
    public CustomBlockOpp(Settings settings) {
        super(settings);
