...
public class CustomSign extends HorizontalFacingBlock {
    public static final MapCodec<CustomSign> CODEC = Block.createCodec(CustomSign::new);
    public CustomSign(Settings settings) {
        super(settings);
